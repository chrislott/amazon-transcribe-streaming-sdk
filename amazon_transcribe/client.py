...
from amazon_transcribe.model import (
    ...
    StartCallAnalyticsStreamTranscriptionEventStream,
    ChannelDefinition,
    ConfigurationEvent,
...
class TranscribeStreamingClient:
    ...
    async def start_stream_transcription(
        ...
        *,
        ...
        language_options: Optional[str] = None,
        preferred_language: Optional[str] = None,
        vocabulary_names: Optional[str] = None,
        vocabulary_filter_names: Optional[str] = None,
    ) -> StartStreamTranscriptionEventStream:
    ...
    async def start_call_analytics_stream_transcription(
        ...
        *,
        ...
        post_call_analytics_settings: Optional[PostCallAnalyticsSettings] = None,
    ) -> StartCallAnalyticsStreamTranscriptionEventStream:
        """Coordinate transcription settings and start stream.
        ...
        :param post_call_analytics_settings
            Settings to enable post call analytics.

        """
        transcribe_streaming_request = StartCallAnalyticsStreamTranscriptionRequest(
            language_code,
            media_sample_rate_hz,
            media_encoding,
            vocabulary_name,
        ...
        request = self._serializer.serialize_start_call_analytics_stream_transcription_request(
            endpoint=endpoint,
            request_shape=transcribe_streaming_request,
        ).prepare()
        ...
        parsed_response = (
            self._response_parser.parse_start_call_analytics_stream_transcription_response(
                resolved_response,
                response,
            )
        )
        ...
        # First event should be configuration event
        configuration_event = ConfigurationEvent(channel_definitions, post_call_analytics_settings)
        await audio_stream.send_configuration_event(configuration_event)

        return StartCallAnalyticsStreamTranscriptionEventStream(audio_stream, parsed_response)
